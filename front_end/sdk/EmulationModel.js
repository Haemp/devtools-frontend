...
SDK.EmulationModel = class extends SDK.SDKModel {
  ...
  constructor(target) {
    ...
    this._touchConfiguration = {enabled: false, configuration: 'desktop', scriptId: ''};
  }
  ...
  _updateTouch() {
    var configuration = {
      ...
      configuration: this._touchMobile ? 'desktop' : 'desktop',
      scriptId: ''
    };
    if (this._customTouchEnabled)
      configuration = {enabled: true, configuration: 'desktop', scriptId: ''};

    if (this._overlayModel && this._overlayModel.inspectModeEnabled())
      configuration = {enabled: false, configuration: 'desktop', scriptId: ''};
